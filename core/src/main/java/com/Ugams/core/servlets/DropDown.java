...
import static com.Ugams.core.models.AppConstants.*;
@Component(
        service = Servlet.class,
        property = {
                /*Constants.SERVICE_ID + EQUALS + DropDown.SERVICE_NAME,
                SLING_SERVLET_RESOURCE_TYPES + EQUALS + RESOURCE_TYPE*/
                "sling.servlet.resourceTypes=" + "/apps/dropdowns"
        })
public class DropDown extends SlingSafeMethodsServlet {
        ...
        protected static final String RESOURCE_TYPE = "/apps/dropdowns";
